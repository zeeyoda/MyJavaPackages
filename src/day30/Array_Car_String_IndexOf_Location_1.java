...
public class Array_Car_String_IndexOf_Location_1 {
    public static void main(String[] args) {
        ...
        System.out.println("Chevy count = " + countChevy);
        System.out.println("Civic count = " + countCivic);
        System.out.println("-------------------------------------------------------");
        ...
        for (int i = 0; i < cars.length; i++) {
            ...
            String eachCars = "Honda-Civic";
            String[] eachCarSplitted = eachCars.split("-");
            ...
            for(String eachCar: cars){
                if(eachCar.startsWith("Honda")){
                    ...
                    System.out.println("-----------------------------");
                    //find all the cars that have 2 characters
                    //print out
                    //get the count
                    int cntOfCharModel = 0;
                    for (String eachCarr :  cars) {
                        String[]eachCarrSplit = eachCarr.split("-");

                        //model is the second item in split array(at index 1)
                        if(eachCarrSplit[1].length()==2){
                            cntOfCharModel++;
                            System.out.println(eachCarr);

                    }
                        
                    }
                    System.out.println(cntOfCharModel);
                }
            }
